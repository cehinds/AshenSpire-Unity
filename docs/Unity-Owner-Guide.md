...
For the current campaign, use [Campaign Owner Guide](Campaign-Owner-Guide.md), [content editing](Content-Authoring-0.6.0.md), and [interruption and return](Interruption-Return-0.8.0.md). The material below records the original 0.1 checkpoint.

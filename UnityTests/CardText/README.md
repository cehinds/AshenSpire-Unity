...
Two further combat commands exercise actual starting weapon composition, frozen baseline profile scaling, owner attribute progression and authored smithing tier 1. Slashing Strike shows and deals 14 damage at Strength 13, increasing to 17 at smithing tier 1, against the fixture's unmodified target. Whole-valued floating numbers generated by equipment display the same totals as authored integers. Fractional, nonfinite and out-of-range values never claim a folded bonus; multiple hits and repetitions keep their separate total contribution. These owner-layer regressions are separate from the unchanged pinned original oracle.
